...
The current version of the library is tested up to the **2017-01-27** version of the Stripe API.
...
```scala
implicit val e = new StripeExecutor("myapikey", apiVersion = "2017-01-27")
```

That would lock your app to the 2017-01-27 version of the API regardless of what the version of the
